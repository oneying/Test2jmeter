...
public class UIBooklist {

	public void Grade(AndroidDriver<WebElement> driver,int grade,int book)throws Exception{
		//教材目录
		//选择某年级
		List<WebElement>choosegrade=driver.findElementsById("com.kouyuyi.kyystuapp:id/grade_num");
	...
	public void Word(AndroidDriver<WebElement> driver)throws Exception{
		//单词练习
	    driver.findElementById("com.kouyuyi.kyystuapp:id/dialog_lesson_word").click();
	}
	
	public void Text(AndroidDriver<WebElement> driver)throws Exception{
		//课文练习
	    driver.findElementById("com.kouyuyi.kyystuapp:id/dialog_lesson_text").click();
	}
