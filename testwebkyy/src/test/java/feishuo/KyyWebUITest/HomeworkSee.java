...
public class HomeworkSee extends BaseTest{
  ...
  public void testHwset()throws Exception{
	  ...
	  classname_result=classname.substring(3);//获得classname里第3个及之后的字符，得到班级名
	 
	  //班级id对应的链接
	  String classid=driver.findElement(By.xpath("//div[@id='c_homeworklist']/div["+i+"]/div/a")).getAttribute("href");
	  classid_result=classid.substring(55);//获得classid里第55个及之后的字符，得到班级id
